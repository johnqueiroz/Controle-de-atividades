...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    ...
    <title>Controle de atividades - Edição de atividades abertas</title>
    ...
    <div>
      ...
      <div><h2 style="padding-bottom:30px;">Edição da atividade "<?php echo $titulo;  ?>"</h2></div>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                        ...
                        <label for="listagem"><b>Listagem</b></label>
      ...
      <form  name="form_delete_atividades" action="delete_atividades_abertas.php" method="POST">
            <div class="form-group col-md-3">
                ...
                <input type="submit" id="botao" style=" margin-top: -98px; margin-left:400px;" class="btn btn-danger" value="Deletar">

            </div>
            <script type="text/javascript">
                                           
                                          var desabilitar_botao = document.getElementById('verifica_manutencao');
                                           var botao = document.getElementById('botao');
                                              // funcao que desabilita o campo de numero de serie quando o checkbox é ativado
                                             
                                              if(desabilitar_botao < 4){
                                                  botao.disabled = true;
                                              }
